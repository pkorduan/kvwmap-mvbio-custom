...
SET @last_layer_id243=LAST_INSERT_ID();

-- Zuordnung Layer 243 zu Stelle 1
INSERT INTO used_layer (`Layer_ID`, `Stelle_ID`, `queryable`, `drawingorder`, `legendorder`, `minscale`, `maxscale`, `offsite`, `transparency`, `postlabelcache`, `Filter`, `template`, `header`, `footer`, `symbolscale`, `requires`, `logconsume`, `privileg`, `export_privileg`, `start_aktiv`, `use_geom`) VALUES (@last_layer_id243, @stelle_id_1, '1', '0', NULL, '-1', '-1', '', NULL, '', '', '', '', '', NULL, NULL, '0', '2', '1', '0', '1');

-- Zuordnung Layer 243 zu Stelle 4
INSERT INTO used_layer (`Layer_ID`, `Stelle_ID`, `queryable`, `drawingorder`, `legendorder`, `minscale`, `maxscale`, `offsite`, `transparency`, `postlabelcache`, `Filter`, `template`, `header`, `footer`, `symbolscale`, `requires`, `logconsume`, `privileg`, `export_privileg`, `start_aktiv`, `use_geom`) VALUES (@last_layer_id243, @stelle_id_4, '1', '0', NULL, '-1', '-1', '', NULL, '', '', '', '', '', NULL, NULL, '0', '2', '1', '0', '1');

-- Zuordnung Layer 243 zu Stelle 5
INSERT INTO used_layer (`Layer_ID`, `Stelle_ID`, `queryable`, `drawingorder`, `legendorder`, `minscale`, `maxscale`, `offsite`, `transparency`, `postlabelcache`, `Filter`, `template`, `header`, `footer`, `symbolscale`, `requires`, `logconsume`, `privileg`, `export_privileg`, `start_aktiv`, `use_geom`) VALUES (@last_layer_id243, @stelle_id_5, '1', '0', NULL, '-1', '-1', '', NULL, '', '', '', '', '', NULL, NULL, '0', '2', '1', '0', '1');

-- Attribut kartiergebiet_id des Layers 243
INSERT INTO layer_attributes (`layer_id`, `name`, `real_name`, `tablename`, `table_alias_name`, `type`, `geometrytype`, `constraints`, `nullable`, `length`, `decimal_length`, `default`, `form_element_type`, `options`, `alias`, `alias_low-german`, `alias_english`, `alias_polish`, `alias_vietnamese`, `tooltip`, `group`, `arrangement`, `labeling`, `raster_visibility`, `dont_use_for_new`, `mandatory`, `quicksearch`, `visible`, `vcheck_attribute`, `vcheck_operator`, `vcheck_value`, `order`, `privileg`, `query_tooltip`) VALUES (@last_layer_id243, 'kartiergebiet_id', 'kartiergebiet_id', 'kartierer', 'kartierer', 'int4', '', 'PRIMARY KEY', '0', '32', '0', '', 'Auswahlfeld', 'SELECT
  kg.id AS value,
...
-- Attribut nutzer_id des Layers 243
INSERT INTO layer_attributes (`layer_id`, `name`, `real_name`, `tablename`, `table_alias_name`, `type`, `geometrytype`, `constraints`, `nullable`, `length`, `decimal_length`, `default`, `form_element_type`, `options`, `alias`, `alias_low-german`, `alias_english`, `alias_polish`, `alias_vietnamese`, `tooltip`, `group`, `arrangement`, `labeling`, `raster_visibility`, `dont_use_for_new`, `mandatory`, `quicksearch`, `visible`, `vcheck_attribute`, `vcheck_operator`, `vcheck_value`, `order`, `privileg`, `query_tooltip`) VALUES (@last_layer_id243, 'nutzer_id', 'nutzer_id', 'kartierer', 'kartierer', 'int4', '', 'PRIMARY KEY', '0', '32', '0', '', 'Auswahlfeld', 'SELECT
  id AS value,
  name AS output
FROM
  mvbio.nutzer', 'Nutzer', '', '', '', '', '', '', '1', '0', NULL, '0', '0', NULL, '1', '', '', '', '1', '0', '0');

-- Zuordnung der Layerattribute des Layers 243 zur Stelle 1
INSERT INTO layer_attributes2stelle (`layer_id`, `stelle_id`, `attributename`, `privileg`, `tooltip`) VALUES (@last_layer_id243, @stelle_id_1, 'kartiergebiet_id', '1', '0');
INSERT INTO layer_attributes2stelle (`layer_id`, `stelle_id`, `attributename`, `privileg`, `tooltip`) VALUES (@last_layer_id243, @stelle_id_1, 'nutzer_id', '0', '0');

-- Zuordnung der Layerattribute des Layers 243 zur Stelle 4
INSERT INTO layer_attributes2stelle (`layer_id`, `stelle_id`, `attributename`, `privileg`, `tooltip`) VALUES (@last_layer_id243, @stelle_id_4, 'kartiergebiet_id', '1', '0');
INSERT INTO layer_attributes2stelle (`layer_id`, `stelle_id`, `attributename`, `privileg`, `tooltip`) VALUES (@last_layer_id243, @stelle_id_4, 'nutzer_id', '0', '0');

-- Zuordnung der Layerattribute des Layers 243 zur Stelle 5
INSERT INTO layer_attributes2stelle (`layer_id`, `stelle_id`, `attributename`, `privileg`, `tooltip`) VALUES (@last_layer_id243, @stelle_id_5, 'kartiergebiet_id', '1', '0');
INSERT INTO layer_attributes2stelle (`layer_id`, `stelle_id`, `attributename`, `privileg`, `tooltip`) VALUES (@last_layer_id243, @stelle_id_5, 'nutzer_id', '0', '0');

-- Replace attribute options for Layer 243
UPDATE layer_attributes SET options = REPLACE(options, 'layer_id=243', CONCAT('layer_id=', @last_layer_id243)) WHERE layer_id IN (@last_layer_id243) AND form_element_type IN ('Autovervollständigungsfeld', 'Auswahlfeld', 'Link','dynamicLink');
UPDATE layer_attributes SET options = REPLACE(options, '243,', CONCAT(@last_layer_id243, ',')) WHERE layer_id IN (@last_layer_id243) AND form_element_type IN ('SubFormPK', 'SubFormFK', 'SubFormEmbeddedPK');

--
-- Benenne vorhandenen Layer Kartierer um in Nutzer und nehme Änderungen daran vor
--
UPDATE
  `layer`
SET
