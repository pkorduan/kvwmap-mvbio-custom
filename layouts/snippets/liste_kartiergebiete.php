...
/*		e.preventDefault();
	...
	function kartiergebieteEditFunctionsFormatter(value, row) {
		...
		output = '<a href="index.php?go=Layer-Suche_Suchen&selected_layer_id=147&value_kartiergebiet_id=' + value + '&operator_kartiergebiet_id==&csrf_token=<? echo $_SESSION['csrf_token']; ?>"><i class="btn-link fa fa-lg fa-' + icon + '"></i></a>';
		return output;
	}
</script>
...
<table
	...
	data-query-params="go=Layer-Suche_Suchen&selected_layer_id=147<?php echo $kampagne_filter; ?>&anzahl=10000&mime_type=formatter&format=json"
