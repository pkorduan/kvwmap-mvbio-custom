...
*/
	...
	$sql = "
		INSERT INTO archiv.kurzboegen(
			...
			label,
			lfd_nr_kr,
			biotopname, standort, flaeche, schutz_bio, altbestand, alt_giscod, alt_lfd_nr, alt_bearb, alt_datp20, hc, hcp, uc1, uc2, vegeinheit, wert_krit_1, wert_krit_2, wert_krit_3, wert_krit_4, wert_krit_5, wert_krit_6, wert_krit_7, wert_krit_8, wert_krit_9, wert_krit_10, wert_krit_11, wert_krit_12, wert_krit_13, wert_krit_14, wert_krit_15, wert_krit_16, gefaehrdg, gefcode, ohnegefahr, empfehlung, fauna, bearbeiter, e_datum, l_datum, foto, aend_datum, pruefer, pruefdatum, lock, legende, import_table, bearbeitungsstufe, geom
		)
		SELECT
			id AS kartierobjekt_id,
			kampagne_id, kartiergebiet_id, kartierebene_id, bogenart_id, user_id,
			label,
			lfd_nr_kr, biotopname, standort, flaeche, schutz_bio, altbestand, alt_giscod, alt_lfd_nr, alt_bearb, alt_datp20, hc, hcp, uc1, uc2, vegeinheit, wert_krit_1, wert_krit_2, wert_krit_3, wert_krit_4, wert_krit_5, wert_krit_6, wert_krit_7, wert_krit_8, wert_krit_9, wert_krit_10, wert_krit_11, wert_krit_12, wert_krit_13, wert_krit_14, wert_krit_15, wert_krit_16, gefaehrdg, gefcode, ohnegefahr, empfehlung, fauna, bearbeiter, e_datum, l_datum, foto, aend_datum, pruefer, pruefdatum, lock, legende, import_table, bearbeitungsstufe, geom
		FROM
