			...
			if (T311_1_1!==-1 && T311_1_2!==-1 && T311_1_3!==-1 && T311_1_4!==-1 && T311_1_5!==-1) {
				...
				if (T311_1_1 || T311_1_2 || T311_1_5) {
					...
					if (T311_1_6 === true) {
						...
						result = {err:'Bestätigen Sie, dass keine Beeinträctigungen erkennbar sind oder wählen Sie die Gefährdungen im Grundbogen!'};
					}
				}
			}
		}
	...
	this.bewerte=function(b) {
		...
		if ([1340, 5130, 6120, 6210, 6230, 6240, 6410, 6440, 6510].indexOf(lrtCode) >= 0) {
			if (!isNaN(T323_1) && T323_1 > 0 ) {
				...
				result = {err:'Bitte Nutzung im Grundbogen eintragen!'};
			}
		}
		this.result=result;
	}
...
function BewertungMoore_1_1_1() {
	...
	this.berechne=function(b) {
		...
		7140 HC und NC = “MAT, MAG, MDH, MTR, MTO, MSS, MST, MSW, MSP, MZB, MZS, MPB“
		...
		*/
		if (lrtCode === 7120) {
			...
			aCodes = ["MAT", "MAG", "MDH", "MTR", "MTO", "MSS", "MST", "MSW", "MSP", "MZB", "MZS", "MPB"];
	...
	this.bewerte=function(b) {
		...
		if (lrtCode === 1210) {
			...
			if (isNaN(T211_1_3) || T211_1_3===-1) {
				result = {b:0, err:"Es muss eine Region Ost/West gewählt sein (Grundbogen)."};
			}
			else {
				if (!isNaN(T211_1_2)) {
					result = 0;					
...
function Bewertung() {
	...
	this.isRequired=function(b) {;
		return this.lrtCodes.indexOf(b.lrtCode)>=0;
	}
}
...
function Gruppenbewertung(dsBewertung, grpNr) {
	...
	this.bewerte=function(b) {		
		// console.info("Gruppenbewertung.bewerte", b);
		var result;
		var korrekturen = 0;
